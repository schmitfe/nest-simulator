...
allspikes = nest.Create("spike_recorder")
...
nest.Connect(nodes_ex + nodes_in, allspikes, syn_spec="excitatory")
...
nest.raster_plot.from_device(allspikes, colorgroups=[("k", nodes_ex[::100]), ("darkred", nodes_in[::100])])
plt.show()
